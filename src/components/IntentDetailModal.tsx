...
export default function IntentDetailModal({ intent, onClose }: IntentDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 dark:bg-black/80 backdrop-blur-md flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl max-w-2xl w-full p-6 shadow-2xl relative my-8 text-zinc-900 dark:text-zinc-200 transition-colors">
        ...
        <button
          onClick={onClose}
          className="absolute top-4 right-4 text-zinc-500 hover:text-black dark:text-zinc-400 dark:hover:text-white p-1 rounded-lg bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 transition-colors"
        >
          <X className="w-4 h-4" />
        </button>
        ...
        <div className="flex items-start space-x-4 pr-8">
          <div className="w-10 h-10 rounded-full bg-zinc-200 dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-700 flex items-center justify-center text-zinc-900 dark:text-white font-bold text-sm shrink-0 overflow-hidden">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <h2 className="text-base font-bold text-zinc-900 dark:text-white">{buyerName}</h2>
        ...
        <div className="mt-6 pt-4 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-2 text-xs font-semibold text-zinc-800 dark:text-zinc-200 bg-zinc-100 dark:bg-zinc-800 hover:bg-zinc-200 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 rounded-lg transition-all inline-flex items-center space-x-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-2 text-xs font-bold text-white dark:text-black bg-black dark:bg-white hover:bg-zinc-800 dark:hover:bg-zinc-200 rounded-lg transition-all inline-flex items-center space-x-2"
          >
