    ...
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="border-b border-zinc-800 bg-black/60 text-[11px] font-mono uppercase tracking-wider text-zinc-400">
              ...
              <tr>
                <td colSpan={3} className="py-12 text-center text-zinc-500">
                  <div className="max-w-sm mx-auto flex flex-col items-center">
                    ...
                    <p className="font-medium text-zinc-400">No matching buyers found</p>
                  </div>
                </td>
              </tr>
            ) : (
                ...
                >
                  ...
                  <td className="py-3.5 px-4 sm:px-6 whitespace-nowrap">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="font-bold text-zinc-100 group-hover:text-white transition-colors block text-xs">
                  ...
                  <td className="py-3.5 px-4 sm:px-6">
                    <p
                      dir="auto"
                      className="text-xs text-zinc-200 line-clamp-2 leading-relaxed hebrew-text group-hover:text-white transition-colors"
                    >
                  ...
                  <td className="py-3.5 px-4 sm:px-6 whitespace-nowrap text-xs text-zinc-400 text-right">
