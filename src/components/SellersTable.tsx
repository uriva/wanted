    ...
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden shadow-sm">
      ...
      <div className="p-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-black/40">
        <div className="relative max-w-md">
          ...
          <input
            type="text"
            placeholder="Search sellers, normalized offers, or names..."
            value={searchTerm}
              ...
              filteredIntents.map((item) => {
                ...
                return (
                  <tr
                    ...
                    title="Click row to view original offer and discussion context"
                        ...
                        <div className="flex items-center space-x-2 flex-wrap gap-y-1.5 pt-0.5">
                          ...
                          {fbProfileUrl && (
                            <a
                              ...
                              rel="noreferrer"
                              onClick={(e) => e.stopPropagation()}
                              title={`View ${item.buyer?.name || "Seller"}'s Facebook profile`}
